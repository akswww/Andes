...
enum ApiPathConstants: String {
    ...
    case UserInfo = "v1/user_info"
    case mapPath = "v1/get_path"
    case measure = "v1/get_measure"
    ...
    case appoint = "v1/add_appointment"
    case medical = "v1/add_medical_case"
    case nfcRegister = "v1/nfc_tag_register"
    case nfcRead = "v1/nfc_tag_read"
}
